...
<head>
    ...
    <title>Discussion App - @yield('title')</title>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-standard shadow-sm">
            <div class="container">
                <a class="navbar-brand bg-interactive-thin" href="{{ url('/home') }}">
                    {{ config('app.name', 'Call Of Duy Discussion Application') }}
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto bg-interactive-thin">
